...
public interface Server {
	...
	//
	// Alguns dos métodos a seguir especificam um trecho de uma lista de
	// mensagens através
	// de parâmetros {startTime}, {endTime} (datahoras), e {maxN} (inteiro
	// positivo).
	//
	...
	// das
	// mensagens com datahora maior ou igual a {startTime} e menor ou igual a
	// {endTime},
	// truncadas em no máximo {|maxN|} mensagens.
	//
	// Se {endTime} for omitido ("" ou {null} no formato externo, -1 no formato
	// interno),
	// supõe-se que {endTime} é o fim dos tempos. Se {startTime} for omitido
	// (idem), supõe-se que
