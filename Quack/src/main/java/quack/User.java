...
public interface User {
	...
	// CONTATOS
	//
	// Um contato é um par ordenado de usuários com mais alguns atributos, {(A,B,...)},
	...
	// segue (ou bloqueia, ou tem alguma outra relação) com o /usuário alvo/ {B}.
	//
	// Há no máximo um contato, ativo ou inativo, para cada par de usuários (origem e alvo).
	// Por enquanto, contatos nunca são eliminados, apenas podem ter seus atributos
	// alterados de modo a se tornarem inativos.  
	//
	// Cada instância {this} de {User} tem uma lista de /contatos diretos/, em 
	// que o usuário {this} é origem; isto é, os usuários que ele segue/bloqueou/etc..
	...
	// Acrescenta à lista {this.getDirectContacts()} o contato dado, que deve ter.
