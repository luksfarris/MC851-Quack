...
<%
  ...
  pageContext.setAttribute("followers", followers);
...
<html>
  <head>
    <meta charset="UTF-8" />
    <title>Quack - Seguidores de @${user.getLoginName()}</title>
        ...
        <div class="col-md-3 user-info">
          ...
          <div>
            <div class="list-group">
              ...
              <a href="Followers?id=${id}" class="list-group-item active">Seguidores <span class="badge">${user.followersCount()}</span></a>
